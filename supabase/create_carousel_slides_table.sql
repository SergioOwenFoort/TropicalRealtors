-- Create carousel_slides table for storing carousel images and links
CREATE TABLE IF NOT EXISTS public.carousel_slides (
  ...
  -- Ensure unique combination of island, period, year, and display_order
  UNIQUE(island, period_number, year, display_order)
);

-- Create RLS policies for carousel_slides table
