            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <div className="relative" onMouseEnter={handleInfoMenuEnter} onMouseLeave={handleInfoMenuLeave}>
                ...
                {isInfoDropdownOpen && (
                  ...
                  >
                    <Link to="/info-sint-maarten" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 whitespace-nowrap" onClick={closeAllMenus}>Info Sint-Maarten</Link>
