          ...
          <div className="flex flex-col items-center justify-center h-64">
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-md">
              ...
              <p className="text-blue-700">
                We zijn bezig met het uitbreiden van ons team op Curaçao. Kom binnenkort terug om onze lokale makelaars te ontmoeten.
              </p>
            </div>
          </div>
        ) : (
              ...
              {realtors.map(realtor => (
                <div key={realtor.id} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:shadow-lg hover:-translate-y-1">
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4">
                      <button 
                        onClick={() => openRealtorEmail(realtor.email, realtor.name, realtor.companyName)}
